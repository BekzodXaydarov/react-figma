  ...
  return (
    <section className="hero container-padding">
       <div className="hero-info">
        <h3 className="hero-info-text">Explorer and Travel</h3>
        <h1 className="hero-info-title">Let’s Go Now</h1>
        <p className="hero-info-description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
